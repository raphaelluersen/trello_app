  ...
  return (
    ...
    <div className="fixed inset-0 overflow-y-auto">
        ...
        <div className="mt-2">
            ...
            className="w-full boarder boarder-gray-300 rounded-md outline-none p-5"
        ...
        <div>
            ...
            className="w-full border border-gray-300 rounded-md outline-none p5 focus-viseble:ring-2 
        ...
        <div className="mt-2">
          <button
            ...
            className="Inline-flex jsutify-center rounded-md border border-transparent bg-blue-100 px-4 py-2
